...
| Clearning                 | 4                     | Clean the flors in the main store and clean the tables in Burger King to ensure all the tables are clean, the floors are spotless and nobody slips\! | <Tooltip tip="Junior Store Colleague">JSC</Tooltip> |
...
[HOST]: You will be given a number (1 or 2). Please remember this number, as you will need to know what break to go to.
...
Take a picture, then do promotions. 

### Dismissal

`h The session has now ended. All staff have been dismissed and the Meeting Room is now SHR+ only unless permissions from SHR+.`

# Logging

<Danger>
  You are now required to log your shift in our intel server.
</Danger>

Log your shift in the intel server. Once the session is over, the Meeting Room is locked to SHR only. SHR can give perms for others to be in there.